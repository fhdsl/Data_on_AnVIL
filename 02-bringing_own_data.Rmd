...
AnVIL workspaces automatically comes with 50GB of storage (the persistent disk), as well as a unique workspace bucket.
...
The persistent disk is created when you provision your computing environment. When you shut down your computing environment, you can the persistent disk, or maintain the persistent disk for monthly cost. 
...
**However**, if you choose to copy the data to the persistent disk, you risk deleting it when you close down your computing environment. A safer option is to copy the data to the associated workspace bucket, which does not get deleted when the computing environment is closed.
