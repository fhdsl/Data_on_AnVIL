...
One of the most common questions people have when using the AnVIL platform is "how do I get the data?" We created this book to provide step-by-step examples for users follow so that they can feel confident finding or moving data onto AnVIL. Each vignette is quick (designed to take ~15 minutes) and will incur minimal costs.
...
* Importing data from GenBank (Coming Soon!)
* Importing data from GEO (Coming Soon!)

**Finding data stored on AnVIL** 
Do you want to access a dataset that's been stored on AnVIL? These vignettes cover how to find and retrieve both open and controlled access datasets in the AnVIL data repository.

* Accessing open access data stored on AnVIL Explorer (Coming Soon!)
* Accessing controlled access data from dbGAP (Coming Soon!)
