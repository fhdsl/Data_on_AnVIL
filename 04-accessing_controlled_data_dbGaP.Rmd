...
```{r, echo=FALSE, fig.alt="Open your AnVIL profile settings by clicking on the three line icon in the upper lefthand corner and then choosing Profile."}
ottrpal::include_slide("https://docs.google.com/presentation/d/1lSUfsg_oja-Iqq5pTFD1VOuR32GLUq2l-sCBYNO3OTg/edit?slide=id.g3e6e33dc82b_0_0#slide=id.g3e6e33dc82b_0_0")
```

Next, look for the tab labeled "External Identities". Click "log in to RAS" under the NIH Researcher Auth Service (RAS) section.

```{r, echo=FALSE, fig.alt="Under the External Identities tab, choose the box that says 'Log in to RAS' under the NIH Researcher Auth Service (RAS) section."}
ottrpal::include_slide("https://docs.google.com/presentation/d/1lSUfsg_oja-Iqq5pTFD1VOuR32GLUq2l-sCBYNO3OTg/edit?slide=id.g3e6e33dc82b_0_5#slide=id.g3e6e33dc82b_0_5")
```
...
```{r, echo=FALSE, fig.alt="An NIH login page will open in a new tab."}
ottrpal::include_slide("https://docs.google.com/presentation/d/1lSUfsg_oja-Iqq5pTFD1VOuR32GLUq2l-sCBYNO3OTg/edit?slide=id.g3e6e33dc82b_0_9#slide=id.g3e6e33dc82b_0_9")
```
