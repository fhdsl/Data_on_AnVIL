...
You can also set a cost limit for a particular workflow. The option for setting a cost threshold is located just underneath the choose sample option on the workflow setup page.
:::
